...
public class BinaryNode<T> {
    ...
    public String toString() {
        ...
        return Newstring(output,0);

    }
 private String Newstring (String output, int def){
     String d="";
     if (this.left != null)
         output=this.left.Newstring(output,def+1);
     for (int i = 0; i < def; i = i + 1) {
         d = d + "  ";
     }
     output =output+ d + this.data + "\n";
     if (this.right != null) {
         output = this.right.Newstring(output,def+1);
     }
     return output;
